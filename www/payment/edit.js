...
function pay_invoice( invoice_id ) {
  $j.ajax({
    ...
    success: function(html) {
      $j('#Paid').html(html);
      if (typeof TableKit !== 'undefined') TableKit.reloadTable('paid');
      load_unpaid();
    },
    error: function(e){
...
function unpay_invoice( invoice_id ) {
  $j.ajax({
    ...
    success: function(html) {
      $j('#Unpaid').html(html);
      if (typeof TableKit !== 'undefined') TableKit.Sortable.init('unpaid');
      load_paid();
    },
    error: function(e){
...
function load_paid( ) {
  $j.ajax({
    ...
    success: function(html) {
      $j('#Paid').html(html);
      if (typeof TableKit !== 'undefined') TableKit.Sortable.init('paid');
    },
    error: function(e){
...
function load_unpaid( ) {
  $j.ajax({
    ...
    success: function(html) {
      ...
      if (typeof TableKit !== 'undefined') TableKit.reloadTable('unpaid');
    },
    error: function(e){
