...
function calc(){
  ...
  pgs = document.autoSumForm.pages.options[document.autoSumForm.pages.selectedIndex].value;
  ...
  hol = document.autoSumForm.holedrilling1.options[document.autoSumForm.holedrilling1.selectedIndex].value;
  sti = document.autoSumForm.stitching1.options[document.autoSumForm.stitching1.selectedIndex].value;
  ...
  Singolo1 = (((((qty / tft) * (pap * 1)) + ((qty / tft) * (pef * 1)) + ((qty / tft) * (hol * 1)) + ((qty / tft) * (sti * 1)) + (trn * 1) + (clr * 1) + (bpz * 1)) * (pgs * 1)) / (qty * 1)); 
  
  stotale1 = ((((qty / tft) * (pap * 1)) + ((qty / tft) * (pef * 1)) + ((qty / tft) * (hol * 1)) + ((qty / tft) * (sti * 1)) + (trn * 1) + (clr * 1) + (bpz * 1)) * (pgs * 1)); 
...
//-->
<!--
function setForm9Value() {
    var selectedItem      = document.autoSumForm.holedrilling1.selectedIndex;
    var selectedItemText  = document.autoSumForm.holedrilling1.options[selectedItem].text;
    
    if (selectedItem != -1) {
        document.autoSumForm.holedrilling.value = selectedItemText;
    }
    else {
        document.autoSumForm.holedrilling.value = "";
      
    }
}
//-->
<!--
function setForm8Value() {
    var selectedItem      = document.autoSumForm.stitching1.selectedIndex;
    var selectedItemText  = document.autoSumForm.stitching1.options[selectedItem].text;
    
    if (selectedItem != -1) {
        document.autoSumForm.stitching.value = selectedItemText;
    }
    else {
        document.autoSumForm.stitching.value = "";
