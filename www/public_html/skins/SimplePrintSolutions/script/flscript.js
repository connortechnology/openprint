...
function calc(){
  ...
  Singolo1 = ((((qty / tft) * (pap * 1)) + ((qty / tft) * (pef * 1)) + ((qty / tft) * (hol * 1)) + ((qty / tft) * (wid * hei * 1)) + ((qty / tft) * (scr * 1)) + (trn * 1) + (clr * 1) + (bpz * 1)) / (qty * 1)); 
  
  stotale1 = (((qty / tft) * (pap * 1)) + ((qty / tft) * (pef * 1)) + ((qty / tft) * (hol * 1)) + ((qty / tft) * (wid * hei * 1)) + ((qty / tft) * (scr * 1)) + (trn * 1) + (clr * 1) + (bpz * 1)); 
