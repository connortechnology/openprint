...
SQL = "SELECT * FROM doorhangerprice"
  ...
  <tr>
    <td width="260" valign="top">
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <font class=textsize>4 x 6&nbsp; | <a href="postcard5x7s.asp" class="linksize">5 x 7</a>
            |
            <a href="postcard6x9s.asp" class="linksize"> 6 x 9</a> |  <a href="postcard6x11s.asp" class="linksize"> 6 x 11</a></font>
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <a href="../templates/doorhanger.asp" class="linksize">Download templates</a><br>
</td>
        </tr>
      </table>
    </td>
