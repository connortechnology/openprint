<%@ Language="VBScript"%>
<%Title="Produts/Postcard"%>
<% Dim step, insdiscount
	step = "fase1"
	insdiscount = 100 
	choosescript= "postcard" 
%>
...
SQL = "SELECT * FROM PostcardPrice6x11"
...
<input name="sizep" type=hidden value="6 x 11" size="10">
...
<input type=hidden onFocus="startCalc();" onBlur="stopCalc();" size=1 name=paper1 value="<%=rs("price12")%>">
<input name="paper" type=hidden value="<%=rs("desc12")%>" size="10">
 <table border="0" cellspacing="1" width="560">
  <tr>
    <td width="260" valign="top">
      <table border="0" cellpadding="10" cellspacing="0" width="100%" height="25">
        <tr>
          <td width="100%" height="260">
            <p align="center"><img border="0" src="images/Postcardico.jpg"></td>
        </tr>
        <tr>
          <td width="100%" height="34" class=textorange><b>Postcard:<br>
             </b>
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <font class=textsize><a href="postcard4x6s.asp" class="linksize">4 x 6</a> | <a href="postcard5x7s.asp" class="linksize">5 x 7</a> | <a href="postcard6x9s.asp" class="linksize">6 x 9</a> | 6 x 11</font>
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>           </tr>
        <tr>
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <a href="../templates/postcards.asp" class="linksize">Download templates</a><br>
</td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td width="100%" height="55" valign="top" class=textorange>Colors&nbsp;<br>
      ...
      <SELECT onChange="startCalc(); setForm2Value()" onBlur="stopCalc();" size=1 name=color1>
      	<option value='<%=rsx("price1")%>'><%=rsx("desc1")%></OPTION>
		<option value='<%=rsx("price2")%>'><%=rsx("desc2")%></OPTION>
		</SELECT><br>
  ...
  <tr>
    <td width="100%" height="21" valign="top" class=textorange>Perforation<br>
 	...
 	<SELECT onChange="startCalc(); setForm5Value()" onBlur="stopCalc();" size=1 name=perforation1>
      ...
      <OPTION value='<%=rs3x("price1")%>'><%=rs3x("desc1")%></OPTION></SELECT>
<br><input name="perforation" type=hidden value="<%=rs3x("desc2")%>" size="10">
