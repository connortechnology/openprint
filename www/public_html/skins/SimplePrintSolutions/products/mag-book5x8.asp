...
SQL = "SELECT * FROM BookletPrice5x8"
...
<input name="sizep" type=hidden value="5.5 x 8.5" size="10">
  ...
  <tr>
    <td width="260" valign="top">
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15">
          <br>
            <font class=textsize><a href="mag-book.asp" class="linksize">6 x 6</a>  | 5.5 x 8.5
       |
            <a href="mag-book8x11.asp" class="linksize"> 8.5 x 11</a>  |&nbsp;<a href="mag-book12x12.asp" class="linksize">12 x 12</a></font></td>
        </tr>
        <tr>
