...
SQL = "SELECT * FROM GreetingCPrice8x5"
...
<input name="sizep" type=hidden value="8 x 5" size="10">
  ...
  <tr>
    <td width="260" valign="top">
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <font class=textsize><a href="greetingcard4x6.asp" class="linksize">4 x 6 Fold</a> | <a href="greetingcard5x7.asp" class="linksize">5 x 7
            Fold</a>  |  8 x 5  Fold <br> </font>
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
          </td>
        </tr>
        <tr>
