...
SQL = "SELECT * FROM PosterPrice18x24"
...
<input name="color1" type=hidden onFocus="startCalc();" onBlur="stopCalc();" value="<%=rsx("price2")%>" size="10">
<input name="color" type=hidden value="<%=rsx("desc2")%>" size="10">
<input name="paper1" type=hidden onFocus="startCalc();" onBlur="stopCalc();" value="<%=rs("price9")%>" size="10">
 ...
 <table border="0" cellspacing="1" width="560">
  <tr>
    <td width="260" valign="top">
      <table border="0" cellpadding="10" cellspacing="0" width="100%" height="1">
        <tr>
          <td width="100%" height="153">
            <p align="center"><img border="0" src="images/Posterico.jpg"></td>
        </tr>
        <tr>
          <td width="100%" height="34" class=textorange><b>Poster Size:<br>
            </b>
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <font class=textsize><a href="poster12x17s.asp" class="linksize">12.75 x 17.25</a> | 18 x 24 |&nbsp;
            <a href="poster24x36s.asp" class="linksize"> 24 x 36</a> <br> </font>
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <font class=textsize> Printed on 12pt Gloss Cover</font></td>
        </tr>
        <tr>
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <a href="../templates/posters.asp" class="linksize">Download templates</a><br>
</td>
        </tr>
      </table>
    </td>
...
<table border="0" cellspacing="1" width="100%" height="293">
  ...
  <tr>
    <td width="100%" bgcolor="#FFFFFF" height="1">
   <table border="0" cellpadding="5" cellspacing="5" width="100%" height="1"  class=back3>
        <tr>
          <td width="100%" height="1">
          <!-- THIRD BOX -->
           <table border="0" cellspacing="0" width="100%" height="1">
