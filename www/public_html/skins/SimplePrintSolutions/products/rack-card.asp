<%@ Language="VBScript"%>
<%Title="Produts/Rack Card"%>
<% Dim step, insdiscount
	step = "fase1"
	insdiscount = 100 
	choosescript= "rackcard" 
%>
...
<input type=hidden name=product value="Rack Card">
 ...
 <table border="0" cellspacing="1" width="560">
  <tr>
    <td width="260" valign="top">
      <table border="0" cellpadding="10" cellspacing="0" width="100%" height="1">
        <tr>
          <td width="100%" height="153">
            <p align="center"><img border="0" src="images/RackCardsico.jpg"></td>
        </tr>
        <tr>
          <td width="100%" height="34" class=textorange><b>Rack Card Size:<br>
            </b>
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <a href="../templates/rackc.asp" class="linksize">Download templates</a><br>
</td>
        </tr>
...
<table border="0" cellspacing="0" width="100%" height="1">
            ...
            <tr>
              <td width="100%" height="21" valign="top" class="textorange">Perforation<br>
                ...
                <input name="perforation" type=hidden value="<%=rs3x("desc1")%>" size="10">
</td>
            </tr>
          </table>
