<%@ Language="VBScript"%>
<%Title="Produts/Door Hanger"%>
<% Dim step, insdiscount
	step = "fase1"
	insdiscount = 100 
	choosescript= "doorhanger" 
%>
...
<input name="sizep" type=hidden value="4 x 9" size="10">
 ...
 <table border="0" cellspacing="1" width="560">
  <tr>
    <td width="260" valign="top">
      <table border="0" cellpadding="10" cellspacing="0" width="100%" height="25">
        <tr>
          <td width="100%" height="260">
            <p align="center"><img border="0" src="images/door-hangerico.jpg" width="200" height="242"></td>
        </tr>
        <tr>
          <td width="100%" height="34" class=textorange><b>Door Hanger:<br>
            </b><img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <font class=textsize>4 x 9<br></font>
      ...
      <img border="0" src="../images/spaziatore.gif" height=7 width="15"><br>
            <a href="../templates/doorh.asp" class="linksize">Download templates</a><br>
</td>
        </tr>
      </table>
    </td>
...
<br><input name="perforation" type=hidden value="<%=rs3x("desc2")%>" size="10">
  ...
  <tr>
   ...
   <option  value='<%=rs4x("price2")%>'><%=rs4x("desc2")%></OPTION>
	<option value='<%=rs4x("price1")%>'><%=rs4x("desc1")%></OPTION></SELECT>
<input name="scoring" type=hidden value="<%=rs4x("desc2")%>" size="10">
</td>
  </tr>
</table>
