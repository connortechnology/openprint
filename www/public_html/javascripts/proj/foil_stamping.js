...
function calc( formName ){
    ...
    jsrsExecute( '/jsrs.htm', cbFillResults, 'openprint::print_foil_stamping::external_calc', arguments );
} // end calc()
    ...
    for ( var i = 0; i < pairs.length; i += 1 ){
        if ( pairs[i].indexOf('~') != -1 ) {
            ...
            if ( form.elements[data[0]] ) {
				...
				} else if ( form.elements[data[0]].type == 'radio' ) {
				} else if ( form.elements[data[0]].type == 'checkbox' ) {
				} else {
