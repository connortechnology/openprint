...
qq.FileUploader = function(o){
	...
	qq.extend(this._options, {
		// used to allow an extended drop area
		droparea: null,
		element: null,
...
qq.extend(qq.FileUploader.prototype, {
	...
	_setupDragDrop: function(){
		...
		var dz = new qq.UploadDropZone({
			element: dropArea,
			onEnter: function(e){
				dropArea.addClassName( self._classes.dropActive );
				e.stopPropagation();
			},
			onLeave: function(e){
				e.stopPropagation();
...
*/
	...
	_onComplete: function(id, fileName, result){
		...
		if (result.success){
			item.addClassName( this._classes.success);
		} else {
			item.addClassName( this._classes.fail);
		}		
	},
...
qq.UploadButton.prototype = {
	...
	_createInput: function(){			
		...
		qq.attach(input, 'mouseover', function(){
			self._element.addClassName( self._options.hoverClass );
		});
		qq.attach(input, 'mouseout', function(){
			self._element.removeClassName( self._options.hoverClass );
		});
		qq.attach(input, 'focus', function(){
			self._element.addClassName( self._options.focusClass);
		});
		qq.attach(input, 'blur', function(){
			self._element.removeClassName( self._options.focusClass);
		});
