...
insert into Configuration values ('syslog_db_name', '', 'text', 'Name of the database where the syslog records are stored.', 'Syslog Server Settings');
insert into Configuration values ('syslog_db_username', '', 'text', 'Username to access the database where the syslog records are stored.', 'Syslog Server Settings');
insert into Configuration values ('syslog_db_password', '', 'text', 'Password to access the database where the syslog records are stored.', 'Syslog Server Settings');
insert into Configuration values ('syslog_db_hostname', '', 'text', 'Hostname or ip address of the database server where the syslog records  are stored.', 'Syslog Server Settings');
insert into Configuration values ('syslog_db_driver', 'Pg', 'text', 'Database driver to use to access the database where the syslog records are stored:', 'Syslog Server Settings');
