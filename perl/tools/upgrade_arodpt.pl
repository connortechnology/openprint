...
$src_db = 'arodpt' if ! $src_db;
$dst_db = 'arodpt' if ! $dst_db;
$src_host = 'www.arodpt.com' if ! $src_host;
...
print "upgrading db ...";
`/var/www/testing/perl/tools/db_update.pl $dst_db arodpt arodpt` or $log->error($!);
print "upgrading db ...";
`/var/www/testing/perl/tools/db_update2.pl $dst_db arodpt arodpt` or $log->error($!);
print "upgrading db ...";
`/var/www/testing/perl/tools/db_update3.pl $dst_db arodpt arodpt` or $log->error($!);
print 'Turning off backups...';
$dbh = sql::open_sql( $log, ('database'=>$dst_db, 'driver'=>'Pg','login'=>'arodpt', 'password'=>'arodpt') );
