...
#$openprint::log->debug(" date_select: $value : ($year,$month,$day), order: $$options{order}");
	...
	my $html = '';
	$html .= sprintf('<span id="%1$s_date"><select id="%1$s_year" name="%1$s_year" onchange="%2$s">', $prefix, $$options{'onchange'} );
	$html .= '<option value=""> </option>';
	$html .= return_years( undef, undef, $year );
	$html .= '</select>';
	$html .= sprintf('<select id="%1$s_month" name="%1$s_month" onchange="%2$s">', $prefix, $$options{'onchange'} );
	$html .= '<option value=""> </option>';
	$html .= getmonths( $month );
	$html .= '</select>';
	...
	$html .= getdays( $day, $year, $month );
	$html .= '</select></span>';
	$html .= sprintf('<span id="%1$s_time" class="time"><select id="%1$s_hour" name="%1$s_hour" onchange="%2$s">', $prefix, $$options{'onchange'} );
	$html .= '<option value=""> </option>';
