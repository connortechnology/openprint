...
#,'rotate_sheet',
	...
	if ( $$specs{'txtSignatureType'} ) {
		...
		$$self{'spread_rows'} = Math::Round::nearest(1,$$specs{'txtWidth'} / $$specs{'txtFinalWidth'}) if 1*$$specs{'txtFinalWidth'};
		$$self{'spread_columns'} = Math::Round::nearest(1,$$specs{'txtHeight'} / $$specs{'txtFinalHeight'}) if 1*$$specs{'txtFinalHeight'};
