...
INSERT INTO Users (company_id, email, email_valid, password, firstName, lastname, web_active, ysnAdministrator, type ) values ( 1, 'iconnor@connortechnology.com', true, '{CRYPT}$2a$08$Pk7J8hdXzOBLhyV2FDTqZ.8h347Dg.241H.ynfqBzIzKdYFg6CifK', 'Isaac', 'Connor', 'Y', 'Y', 'A' );
