...
DROP SEQUENCE IF EXISTS FoldSpec_id_seq;
CREATE SEQUENCE FoldSpec_id_seq;
...
CREATE TABLE Folds (
	...
	makeready_overs_units	integer,
	run_overs	integer,
	run_overs_units	integer,
	PRIMARY KEY (id)
);

CREATE TABLE Fold_Specifications (
	id	INTEGER NOT NULL default nextval('FoldSpec_id_seq'),
