...
CREATE TABLE tbl_Project_Contents (
	lngProjectIndex	INT4 NOT NULL,		/* Index into the tbl_Projects table, which identifies the project that the contents belong to */
FOREIGN KEY (lngProjectIndex) REFERENCES tbl_Projects (Index),
