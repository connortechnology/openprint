...
sub find {
	...
	if ( exists $params{'equipment_id in'} ) {
		$sql .= ' AND equipment_id in (' . join(',', map { '?' } @{$params{'equipment_id in'}} ) . ')';
		push @values, @{$params{'equipment_id in'}};
	} # end if
...
>>>>>>> 882df9b48f15a5fe7a8dc07a7b2aa6d8755c4ec8
