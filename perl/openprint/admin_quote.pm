...
sub edit {
    ...
    $_ = q{SELECT 1, curTotalSale1, dblModification1, 2, curTotalSale2, dblModification2, 3, curTotalSale3, dblModification3 FROM tbl_Quotes WHERE Index=?};
    @{$$variable{'TOTALS'}} = sql::execute( $log, $dbh, $_, $quote_id );
} # end sub edit_quote
