...
# Inline pasting
		...
		my %Price = calc_price( $$specs{'txtQuantity'.$qty_index}, $Equipment, $I->pages(), $I->imposition(), $$folding_results{'RunSpeed'}, $services );
...
# Inline pasting
			...
			my %Price = calc_price( $qty, $Equipment, $pages, $imposition, undef, $services );
...
sub calc_price {
	my ( $qty, $Equipment, $pages, $imposition, $runspeed, $services ) = @_;
	my %Price;
	my %MakeReady;
