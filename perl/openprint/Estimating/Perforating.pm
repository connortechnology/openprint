...
# Do nothing, we already know it fits on the machine, and it has to go one way or another.
                        ...
                        if ( $$I{image_orientation} == Imposition::Horizontal ) {
                            $Results{Breakdown} .= 'Running ' . $I->layout_height() . ' on feed of ' . $max_feed_width . '<br/>';
                            if ( $I->layout_height() >= $max_feed_width ) {
...
# Div by imposition
			...
			if ( $$I{image_orientation} == Imposition::Vertical and $$specs{"txtHorizontalQty-$form"} ) {
			...
			} elsif ( $$I{image_orientation} == Imposition::Horizontal and  $$specs{"txtVerticalQty-$form"} ) {
			...
			if ( $$I{image_orientation} == Imposition::Vertical and  $$specs{"txtVerticalQty-$form"} ) {
			...
			} elsif ( $$I{image_orientation} == Imposition::Horizontal and $$specs{"txtHorizontalQty-$form"} ) {
